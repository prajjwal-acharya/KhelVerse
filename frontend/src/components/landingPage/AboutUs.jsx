...
function AboutUs() {
  ...
  return (
    <div id='about-us' className='w-full relative'>
      ...
      {/* Content Section */}
      <motion.div
        className='bg-white h-[85vh] w-full flex flex-col-reverse md:flex-row items-center justify-center'
        style={{
      ...
      >
        ...
        <div className='flex flex-col px-10 mx-10'>
          ...
          <p className=' mb-4 text-md sm:text-lg text-left max-w-[600px]'>
            Minimize setbacks, maximize potential, and build champions. A unified platform that
            streamlines training, tracks progress, and supports career growth—empowering athletes,
            coaches, and organizations to achieve excellence.
          </p>
        </div>
        {/* Right Content */}
        <div className='w-[50vw] md:w-[40vw]  h-[30vh] sm:h-[40vh] mr-10 flex items-center'>
          <img

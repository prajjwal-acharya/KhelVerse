      ...
      <div className='bg-gradient-to-br from-lavender to-pastelYellow h-full w-full py-[50px]'>
        <div className='top'>
          <div className='left'>
            ...
            <p>
              The Indian sports industry is growing, but athlete management is fragmented &
              outdated. We’re here to fix that.
            </p>
            <p>
              <span>APTS</span> is a tech-driven platform that streamlines training, injury
              management, and career growth—all in one place.
            </p>
          </div>

...
function AthleteHero() {
  ...
  return (
    <div
      className='h-[100px] bg-gradient-to-br backdrop-blur-lg  overflow-hidden mb-[10px] w-full flex items-center justify-between text-white  px-[30px] top-0 sticky z-10 '
      style={{
        boxShadow:
